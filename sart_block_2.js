	...
	var welcome = {
      ...
      stimulus: '<div style = "font-size:22px;">This is the last block of the experiment. Click this text, then press any key to continue.</div>'
    };
...
//	  { stimulus: '<div style="font-size:64px;">3</div>', data: { test_part: 'test', correct_response: 'None', font_size: '64'   } },
	...
	var debrief_block = {
		...
		var deviation_2 = Math.round(sd4*100)/100;
			...
			return '<div style = "font-size:22px;">Congratulations, you have finished the experimental part!</div>'+
				"<br>" +
